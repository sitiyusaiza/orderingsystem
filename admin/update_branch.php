...
<head>
    ...
    <title>COOKIE MONSTER  Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Branch</h3> </div>
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from branch where rs_id='$_GET[res_upd]'";//this is for update new branch details using user id

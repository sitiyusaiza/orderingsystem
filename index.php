                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
							...
							<?php
						if(empty($_SESSION["user_id"])) // if user is not login it will show login and sign up button on the top right
							{
							...
							{
									//if user is login it will show My Orders and log out button on the top right

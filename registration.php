...
if(isset($_POST['submit'] )) //when user enter submit button
{
     if(empty($_POST['firstname']) ||  // this will find if its empty or not  if empty user have to fullfill all the input
	...
	elseif(strlen($_POST['password']) < 6)  //calculate password length
	{
		$message = "Password Must be >=6";
	}
	elseif(strlen($_POST['phone']) < 10)  //calculate phone length
	{
	...
	mysqli_query($db, $mql);
   //this javascript will redirect go to login page in 5 second after registration done
